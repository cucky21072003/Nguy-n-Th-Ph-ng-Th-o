...
const Cart = () => {
 return(
  <View style={styles.container}>
     ...
     <View style={styles.item}>
      <Image source={require("../Home/img/bo.jpg")} style={{width:61,height:61}}></Image>
      <View style={{flexDirection:'column',gap:2,marginLeft:20}}>
     ...
     <View style={styles.item}>
      <Image source={require("/Home/img/matcha.jpg")} style={{width:61,height:61}} ></Image>
      <View style={{flexDirection:'column',gap:2,marginLeft:20}}>
